...
The prover performs a combination of the following operations to generate the constraints:
...
They are created from left and right variables \\(a\_L, a\_R\\) of
additional multiplication gates.
Output variables \\(a\_O\\) are intentionally left unconstrained.
