...
mod tests {
    ...
    fn merge_circuit_direct_helper(
        ...
        let t_0 = cs2.alloc_variable();
        let t_1 = cs2.alloc_variable();
        let in_0 = cs2.alloc_variable();
        let in_1 = cs2.alloc_variable();
        let out_0 = cs2.alloc_variable();
        let out_1 = cs2.alloc_variable();
