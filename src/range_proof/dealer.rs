...
//! engaging in an aggregated multiparty computation protocol. For more explanation of 
//! how the `dealer`, `party`, and `messages` modules orchestrate the protocol execution, see
